...
public abstract class HttpContext
{
	...
	/**
	 * Sets the Authenticator for this HttpContext. Once an authenticator is
	 * establised on a context, all client requests must be authenticated, and
	 * the given object will be invoked to validate each request. Each call to
	 * this method replaces any previous value set.
	 * 
	 * @param auth
	 *            the authenticator to set. If <code>null</code> then any
	 *            previously set authenticator is removed, and client
	 ...
	 * 
	 * @return this HttpContext's Authenticator, or <code>null</code> if none is
	 *         set.
	 */
