...
final class HttpsClient extends HttpClient implements HandshakeCompletedListener
{
	...
	/**
	 * Create an HTTPS client URL. Traffic will be tunneled through the
	...
	/**
	 * Create an HTTPS client URL. Traffic will be tunneled through the
	 * specified proxy server, with a connect timeout
	 */
	...
	/**
	 * Get a HTTPS client to the URL. Traffic will be tunneled through the
	 * specified proxy server.
	 */
	...
	static HttpClient New(SSLSocketFactory sf, URL url, HostnameVerifier hv, String proxyHost, int proxyPort, boolean useCache)
			throws IOException
	{
			...
			int connectTimeout) throws IOException
	{
		...
		return HttpsClient.New(sf, url, hv, (proxyHost == null ? null : HttpsClient.newHttpProxy(proxyHost, proxyPort)),
				useCache, connectTimeout);
	}

	static HttpClient New(SSLSocketFactory sf, URL url, HostnameVerifier hv, Proxy p, boolean useCache, int connectTimeout)
			throws IOException
	{
	...
	/**
	 * The following method, createSocket, is defined in NetworkClient and
	 * overridden here so that the socket facroty is used to create new sockets.
	 */
	@Override
